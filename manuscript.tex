...
(\citeproc{ref-drummondIndividualsGreaterScience2017}{Drummond \&
Fischhoff, 2017}; \citeproc{ref-kahanPolarizingImpactScience2012}{Kahan
et al., 2012}). These early findings, however, have largely failed to
replicate
...
2007}), or hiring decisions
(\citeproc{ref-fousianiApplyingRemoteJobs2023}{Fousiani et al., 2023}).
...
Castelain et al.
(\citeproc{ref-castelainEvidenceThatTwoYearOld2018a}{2018}){]} or having
...
(\citeproc{ref-pfanderTrustingForgettingImpressive2025}{2025}) that
...
(\citeproc{ref-mercierMajorityRulesHow2019}{Mercier \& Morin, 2019}). It
...
\citeproc{ref-decondorcetEssaiApplicationAnalyse2014}{De Condorcet,
2014}). This is a problem for the rational impression account, as it
...
in abstract scenarios (\citeproc{ref-pfanderHowWiseCrowd2025}{Pfänder,
De Courson, et al., 2025}), but other research suggests that they are
...
(\citeproc{ref-slomanForgettingPrimedFragment1988}{\textbf{slomanForgettingPrimedFragment1988?}};
\citeproc{ref-parkinDifferentialNatureImplicit1990}{\textbf{parkinDifferentialNatureImplicit1990?}}).
...
(\citeproc{ref-reynaScientificTheoryGist2021}{\textbf{reynaScientificTheoryGist2021?}}),
and that the verbatim memory tends to fade faster
(\citeproc{ref-murphyForgettingVerbatimInformation1994}{\textbf{murphyForgettingVerbatimInformation1994?}}).
...
al., 2010}). Other research has shown that patients with profund
episodic memory impairment due to dementia continue to show capacity for
emotional learning
(\citeproc{ref-evans-robertsRememberingRelationshipsPreserved2010}{\textbf{evans-robertsRememberingRelationshipsPreserved2010?}}).
...
with others
(\citeproc{ref-mahrWhyWeRemember2018}{\textbf{mahrWhyWeRemember2018?}}).
...
\bibitem[\citeproctext]{ref-fousianiApplyingRemoteJobs2023}
